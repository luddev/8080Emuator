...
int DisassembleOp_8080(unsigned char *rom, int pc)
{
	...
	switch(*code)	{
		...
		case 0x0E:	fprintf(stdout, "0x%02x : MVI	C,#0x%02x",pc,code[1] );	opbytes=2;	break;
		case 0x0F:	fprintf(stdout, "0x%02x : RRC	", pc);		opbytes=1;	break;
		case 0x10:	fprintf(stdout, "0x%02x : 0x%02x 	Invalid OpCode.",pc,code[0] ); opbytes=1;	break;
		...
		case 0x16:	fprintf(stdout, "0x%02x : MVI	D,#0x%02x",pc,code[1] );	opbytes=2;	break;
		case 0x17:	fprintf(stdout, "0x%02x : RAL	",pc );		opbytes=1;	break;
		case 0x18:	fprintf(stdout, "0x%02x : 0x%02x 	Invalid OpCode.",pc,code[0] ); opbytes=1;	break;
		...
		case 0x1E:	fprintf(stdout, "0x%02x : MVI	E,#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0x26:	fprintf(stdout, "0x%02x : MVI	H,#0x%02x",pc,code[1] );	opbytes=2;	break;
		case 0x27:	fprintf(stdout, "0x%02x : DAA	",pc );		opbytes=1;	break;
		case 0x28:	fprintf(stdout, "0x%02x : 0x%02x 	Invalid OpCode.",pc,code[0] ); opbytes=1;	break;
		...
		case 0x2E:	fprintf(stdout, "0x%02x : MVI	L,#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0x36:	fprintf(stdout, "0x%02x : MVI	M,#0x%02x",pc,code[1] );	opbytes=2;	break;
		case 0x37:	fprintf(stdout, "0x%02x : STC 	",pc );		opbytes=1;	break;
		case 0x38:	fprintf(stdout, "0x%02x : 0x%02x 	Invalid OpCode.",pc,code[0] ); opbytes=1;	break;
		...
		case 0x3E:	fprintf(stdout, "0x%02x : MVI	A,#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0xC6:	fprintf(stdout, "0x%02x : ADI	#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0xCB:	fprintf(stdout, "0x%02x : 0x%02x 	Invalid OpCode.",pc,code[0] ); opbytes=1;	break;
		...
		case 0xCE:	fprintf(stdout, "0x%02x : ACI 	#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0xD3:	fprintf(stdout, "0x%02x : OUT 	#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0xD6:	fprintf(stdout, "0x%02x : SUI 	#0x%02x",pc,code[1] );	opbytes=2;	break;
		case 0xD7:	fprintf(stdout, "0x%02x : RST 	2",pc );	opbytes=1;	break;
		case 0xD8:	fprintf(stdout, "0x%02x : RC 	 ",pc );	opbytes=1;	break;
		case 0xD9:	fprintf(stdout, "0x%02x : 0x%02x 	Invalid OpCode.",pc,code[0] ); opbytes=1;	break;
		case 0xDA:	fprintf(stdout, "0x%02x : JC 	$%02x%02x",pc,code[2],code[1] );	opbytes=3;	break;
		case 0xDB:	fprintf(stdout, "0x%02x : IN 	#0x%02x",pc,code[1] );	opbytes=2;	break;
		case 0xDC:	fprintf(stdout, "0x%02x : CC 	$%02x%02x",pc,code[2],code[1] );	opbytes=3;	break;
		case 0xDD:	fprintf(stdout, "0x%02x : 0x%02x 	Invalid OpCode.",pc,code[0] ); opbytes=1;	break;
		case 0xDE:	fprintf(stdout, "0x%02x : SBI 	#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0xE6:	fprintf(stdout, "0x%02x : ANI 	#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0xED:	fprintf(stdout, "0x%02x : 0x%02x 	Invalid OpCode.",pc,code[0] ); opbytes=1;	break;
		case 0xEE:	fprintf(stdout, "0x%02x : XRI 	#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0xF6:	fprintf(stdout, "0x%02x : ORI 	#0x%02x",pc,code[1] );	opbytes=2;	break;
		...
		case 0xFD:	fprintf(stdout, "0x%02x : 0x%02x 	Invalid OpCode.",pc,code[0] ); opbytes=1;	break;
		case 0xFE:	fprintf(stdout, "0x%02x : CPI 	#0x%02x",pc,code[1] );	opbytes=2;	break;
